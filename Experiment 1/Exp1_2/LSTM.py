...
# 4. Reshape for LSTM: each feature becomes a timestep
X_train = X_train.reshape(-1, X_train.shape[1], 1)
X_test  = X_test.reshape(-1, X_test.shape[1], 1)

# 5. Define TPE search space for LSTM
space = {
...
# 9. Rebuild final model with best params
model = Sequential()
...
y_prob = model.predict(X_test,
                       batch_size=best_params['batch_size']).ravel()
